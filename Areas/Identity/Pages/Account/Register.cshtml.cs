...
namespace POWApp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        throw new InvalidOperationException("callbackUrl is null. Unable to generate confirmation link.");
                    }
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("El UI predeterminado requiere un almacén de usuarios con soporte para correo electrónico.");
            }
